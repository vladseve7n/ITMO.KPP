...
class Camera:
    def __init__(self, camera: dict, output_path: str, visualize: bool = True):
    ...
    def detect_if_car_is_passed(self, num_of_points: int = 10):
        ...
        for p in check_points:
            ...
            # print(self.name, car_box[0] + x_shift, p[0], car_box[2] + x_shift, '|', car_box[1] + y_shift, p[1], car_box[3] + y_shift, '|', if_x_in_square, if_y_in_square)
